...
const ChatifyPage = () =>{
    ...
    return (
        <div className="  p-5 flex flex-col  items-center  text-center mt-5 ">
            <div className="background"></div>
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Make it easy to start a conversation</h1>
            ...
            {!user &&
                <button onClick={()=> nav('/registration')} className="btn  mt-10 btn-primary text-white px-6 text-lg font-semibold rounded-md shadow-lg">
                    Sign Up Free
                </button>}
